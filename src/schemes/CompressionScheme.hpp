...
public:
  ...
  virtual u32 compress(const INTEGER *src, u8 *dest, const Statistics *stats,
                       const u32 total_size, const u16 block_size) = 0;
  //---------------------------------------------------------------------------
  ...
  /// @param total_size The number of integers over all blocks.
  /// @param block_size The number of integers within a block.
  virtual void decompress(INTEGER *dest, const u8 *src, const u32 total_size,
                          const u16 block_size) = 0;
  //---------------------------------------------------------------------------
