...
//---------------------------------------------------------------------------
// Verifies that the data remains unchanged after compression using RLE
// and a second round of compression using LZ4 on the header.
TEST(RLETest, Phase2HeaderCompressionInvariant) {
  constexpr uint16_t kBlockSize = 256;
...
TEST(RLETest, Phase2PayloadCompressionInvariant) {
  constexpr uint16_t kBlockSize = 256;
...
TEST(RLETest, Phase2CompressionInvariant) {
  constexpr uint16_t kBlockSize = 256;
